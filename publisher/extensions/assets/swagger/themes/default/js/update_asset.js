...
var load_swagger_editor_content = function (){
    var swaggercontent = $('#content').val();
    console.log(swaggercontent);
    if(swaggercontent != ""){
        //var swagYaml = jsyaml.safeDump(swaggercontent);
        window.localStorage.setItem(SWAGGER_CONTENT, swaggercontent);
